...
CELA Chat bot is based on FAQ Plus Bot that can answer user's questions by searching the CELA sharepoint.  
...
A user can ask the bot a question and the bot responds with an answer if it's in the knowledge base. If not, the bot responds with options to contact CELA. 

**We could add features like by leveraging and extending the Expert CS project**
